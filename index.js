...
const BotName = 'Toxic bot'; 
const yt = 'https://youtube.com/channel/UChZ-WBtpY_kXShtzInYL8mQ/'; 
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:TOXIC KKKKK\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5511987671915:+55 11 98767-1915\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const vcard2 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:Criador\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=556598049058:+55 65 9804-9058\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD TOXIC BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Toxic? Este é um recurso especial para o Toxic ❌',
					ownerB: '[❗] Toxic? Este é um recurso especial para o Toxic ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Toxic. Registre-se para fazer amizade com o bot Toxic por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Toxic|17\n\n──「 TOXIC BOT 」──`,
			...
			const ownerNumber = ["5511987671915@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5511987671915@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5511987671915@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5511987671915@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5511987671915@s.whatsapp.net","556598049058@s.whatsapp.net"] 
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('5511987671915@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS TOXIC BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Toxic domina vida
          ...
          reply('Espere..')
			    ...
			    case 'owner':
                    ...
                    break
               case 'qmcriobot':
                    client.sendMessage(from, {displayname: "Jeff", vcard2: vcard}, MessageType.contact, { quoted: mek})
                    client.sendMessage(from, 'Ctt do cara que crio bot pdp',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Toxic ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT TOXIC ✨* 」\n*│+ wa.me/5511987671915*╰──────*「 *TOXIC* 」*────*\n\n*_SE QUER SER ADMIN DO BOT TOXIC_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do Toxic:*\n\n https://youtube.com/channel/UChZ-WBtpY_kXShtzInYL8mQ'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* TOXIC\n*YOUTUBE:* https://youtube.com/channel/UChZ-WBtpY_kXShtzInYL8mQ\n*WPP:* wa.me/+5511987671915\n*INSTA:* tosem\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
